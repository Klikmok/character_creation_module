...
def attack(char_name: str, char_class: str) -> str:
    """Функция вычисляющая урон от атаки в зависимости от класса героя"""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция вычисляющая единицы заблокированного урона в зависимости от класса героя"""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция вычисляющая урон от специальной атаки в зависимости от класса героя"""
    if char_class == 'warrior':
